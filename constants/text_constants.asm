...
DEF CHINESE_FONT_TILE_START     EQU $08
DEF CHINESE_FONT_TILE_HIGH_START EQU $80
DEF CHINESE_FONT_TILES_PER_CHAR EQU 4
DEF CHINESE_FONT_CACHE_LOW_CHARS EQU (CHINESE_FONT_TILE_HIGH_START - CHINESE_FONT_TILE_START) / CHINESE_FONT_TILES_PER_CHAR
DEF CHINESE_FONT_CACHE_CHARS    EQU CHINESE_FONT_CACHE_LOW_CHARS + ($100 - CHINESE_FONT_TILE_HIGH_START) / CHINESE_FONT_TILES_PER_CHAR
DEF CHINESE_FONT_CACHE_WRAM_BANK EQU 2
DEF CHINESE_TOWN_MAP_FONT_CACHE_CHARS EQU 10
DEF CHINESE_FONT_CACHE_EMPTY    EQU $ff
DEF CHINESE_FONT_BANK_CHARS     EQU 512
INCLUDE "constants/chinese_font_constants.asm"
